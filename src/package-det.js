...
function showDetails() {
    ...
    detail.querySelector('.price1').innerText = '$' + thisProduct.price;
    detail.querySelector('.sprice').innerText = 'BOOK NOW FOR $' + thisProduct.price;
